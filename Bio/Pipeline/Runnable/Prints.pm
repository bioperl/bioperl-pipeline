# Pipeline module for Prints Bio::Pipeline::Runnable::Prints
#
# Based on the EnsEMBL module Bio::EnsEMBL::Pipeline::Runnable::Protein::Prints
...
Bio::Pipeline::Runnable::Prints

=head1 SYNOPSIS

 my $runnable = Bio::Pipeline::Runnable::Prints->new(@params);
...
package Bio::Pipeline::Runnable::Prints;
use vars qw(@ISA);
use strict;
use FileHandle;
use Bio::PrimarySeq;
...
sub run {
  ...
  $factory = Bio::Tools::Run::Prints->new(@params);
