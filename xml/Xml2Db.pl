...
use vars qw($DBHOST $DBNAME $DBUSER $DBPASS $DATASETUP $PIPELINEFLOW $JOBFLOW $SCHEMA);

$DBHOST ||= "mysql";
$DBNAME ||= "test_XML";
$DBUSER ||= "root";
$DBPASS ||="";
$SCHEMA = $SCHEMA || "/usr/users/savikalpa/src/biosql-schema/sql/biopipelinedb-mysql.sql";
